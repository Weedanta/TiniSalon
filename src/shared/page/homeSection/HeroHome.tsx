...
const HeroHome = () => {
  return (
    <HeroSection className="gap-4 items-center">
      ...
      />
      <p className="font-medium text-sm sm:text-base md:text-xl xl:text-xl text-center">Salon kecantikan, perawatan diri, dan kursus salon</p>
      <Button variant={"default"} href={"https://share.google/lNH0HRKpSWrmIwEaL"} className="text-center mt-5 font-bold ">LIHAT SALON</Button>
    </HeroSection>
  );
};
